...
class Test_PrepCompPlan(unittest.TestCase):
    ...
    def test_existing_models_existing_metrics_folder_pwc_plan(self):
        ...
        pwc_data = [[True, True, True, False, 1, 'logreg', 'bc', 5, 'float', "resnet16+clip_ViT-B-16_LP+densenet201_model_co_logreg_prec_float"],
                    [True, True, True, False, 1, 'logreg', 'bc', 10, 'float', "resnet16+clip_ViT-B-16_LP+densenet201_model_co_logreg_prec_float"],
                    [True, True, True, False, 1, 'logreg', 'bc', -1, 'float', "resnet16+clip_ViT-B-16_LP+densenet201_model_co_logreg_prec_float"],
                    [True, True, True, False, 1, 'logreg', 'm1', 5, 'float', "resnet16+clip_ViT-B-16_LP+densenet201_model_co_logreg_prec_float"],
                    [True, True, True, False, 1, 'logreg', 'm1', 10, 'float', "resnet16+clip_ViT-B-16_LP+densenet201_model_co_logreg_prec_float"],
                    [True, True, True, False, 1, 'logreg', 'm1', -1, 'float', "resnet16+clip_ViT-B-16_LP+densenet201_model_co_logreg_prec_float"],
                    [True, False, True,False,  2, 'logreg', 'bc', 5, 'float', "resnet16+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, False, True,False,  2, 'logreg', 'bc', 10, 'float', "resnet16+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, False, True,False,  2, 'logreg', 'bc', -1, 'float', "resnet16+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, False, True,False,  2, 'logreg', 'm1', 5, 'float', "resnet16+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, False, True,False,  2, 'logreg', 'm1', 10, 'float', "resnet16+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, False, True,False,  2, 'logreg', 'm1', -1, 'float', "resnet16+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, True, False,False,  3, 'logreg', 'bc', 5, 'float', "densenet201+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, True, False,False,  3, 'logreg', 'bc', 10, 'float', "densenet201+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, True, False,False,  3, 'logreg', 'm1', 5, 'float', "densenet201+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [True, True, False,False,  3, 'logreg', 'm1', 10, 'float', "densenet201+clip_ViT-B-16_LP_model_co_logreg_prec_float"],
                    [False, True, True,False,  4, 'logreg', 'bc', 5, 'float', np.nan],
                    [False, True, True,False,  4, 'logreg', 'bc', 10, 'float', np.nan],
                    [False, True, True,False,  4, 'logreg', 'bc', -1, 'float', np.nan],
                    [False, True, True,False,  4, 'logreg', 'm1', 5, 'float', np.nan],
                    [False, True, True,False,  4, 'logreg', 'm1', 10, 'float', np.nan],
                    [False, True, True,False,  4, 'logreg', 'm1', -1, 'float', np.nan]]
        pwc_columns = ['clip_ViT-B-16_LP', 'densenet201', 'resnet16', 'bubunet325', 'combination_id',
                       'combining_method', 'coupling_method', 'topl',
                       'computational_precision', 'model_file']
